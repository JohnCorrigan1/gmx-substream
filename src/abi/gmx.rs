...
pub mod functions {
    ...
    pub struct EmitEventLog {
        ...
        pub event_data: (
            ...
            (
                Vec<(String, [u8; 32usize])>,
                Vec<(String, Vec<[u8; 32usize]>)>,
            ),
            (Vec<(String, Vec<u8>)>, Vec<(String, Vec<Vec<u8>>)>),
                ...
                &[
                    ...
                    ethabi::ParamType::Tuple(vec![
                        ...
                        ethabi::ParamType::Tuple(vec![
                            ...
                            ethabi::ParamType::Array(Box::new(ethabi::ParamType::Tuple(vec![
                                ethabi::ParamType::String,
                                ethabi::ParamType::Array(Box::new(ethabi::ParamType::FixedBytes(
                                    32usize,
                                ))),
                            ]))),
                        ]),
                                    ...
                                    .map(|inner| {
                                        ...
                                        (
                                            ...
                                            tuple_elements[1usize]
                                                ...
                                                .into_iter()
                                                .map(|inner| {
                                                    inner.into_bytes().expect(INTERNAL_ERR)
                                                })
                                                .collect(),
                                        )
                                    })
                                    ...
                                    .map(|inner| {
                                        ...
                                        (
                                            ...
                                            tuple_elements[1usize]
                                                ...
                                                .into_iter()
                                                .map(|inner| {
                                                    inner.into_string().expect(INTERNAL_ERR)
                                                })
                                                .collect(),
                                        )
                                    })
                    ...
                    ethabi::Token::Tuple(vec![
                        {
                            let v = self
                                ...
                                .map(|inner| {
                                    ethabi::Token::Tuple(vec![
                                        ethabi::Token::String(inner.0.clone()),
                    ...
                    ethabi::Token::Tuple(vec![
                        {
                            let v = self
                                ...
                                .map(|inner| {
                                    ethabi::Token::Tuple(vec![
                                        ethabi::Token::String(inner.0.clone()),
                                        ethabi::Token::String(inner.1.clone()),
                                    ])
                                })
                                .collect();
                            ethabi::Token::Array(v)
...
pub mod events {
    ...
    impl EventLog {
        const TOPIC_ID: [u8; 32] = [
            126u8, 59u8, 222u8, 43u8, 167u8, 172u8, 164u8, 168u8, 73u8, 150u8, 8u8, 202u8, 87u8,
            243u8, 176u8, 193u8, 193u8, 201u8, 58u8, 206u8, 99u8, 255u8, 211u8, 116u8, 26u8, 159u8,
            171u8, 32u8, 65u8, 70u8, 252u8, 154u8,
        ];
    ...
    impl EventLog1 {
        const TOPIC_ID: [u8; 32] = [
            19u8, 122u8, 68u8, 6u8, 124u8, 137u8, 97u8, 205u8, 126u8, 29u8, 135u8, 111u8, 71u8,
            84u8, 165u8, 163u8, 167u8, 89u8, 137u8, 180u8, 85u8, 47u8, 24u8, 67u8, 252u8, 105u8,
            195u8, 179u8, 114u8, 222u8, 241u8, 96u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl EventLog2 {
        const TOPIC_ID: [u8; 32] = [
            157u8, 93u8, 104u8, 91u8, 17u8, 69u8, 14u8, 183u8, 182u8, 108u8, 222u8, 24u8, 62u8,
            2u8, 193u8, 184u8, 221u8, 224u8, 81u8, 150u8, 109u8, 163u8, 117u8, 102u8, 183u8, 159u8,
            11u8, 161u8, 145u8, 72u8, 90u8, 197u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
